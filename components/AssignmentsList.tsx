...
const AssignmentsList = () => {
  ...
  return (
    <div className="relative w-full h-full flex flex-col pt-4">
      {/* Header Section */}
      <div className="px-8 flex flex-col space-y-1 mb-6">
      ...
      <div className="px-8 flex items-center justify-between mb-4 w-full">
      ...
      {/* Cards Grid */}
      <div className="px-8 flex-1 overflow-y-auto pb-[120px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {assignments.map((assignment, index) => (
            <div
              key={index}
              className="bg-white rounded-[16px] p-5 flex flex-col justify-between h-[162px] shadow-sm border border-gray-100 relative group cursor-pointer hover:shadow-md transition-all"
            >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[100px] bg-gradient-to-t from-[#EAEAEA]/90 to-transparent backdrop-blur-[2px] flex items-end justify-center pb-8 z-10 pointer-events-none rounded-b-[16px]">
